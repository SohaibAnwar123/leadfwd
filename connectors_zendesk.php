...
<body>
    ...
    <main class="wrapper-940">
        ...
        <h5 class="centerAl">Zendesk + Leadfwd</h5>
        
        <div class="connectors-img">
            <img class="mb20" src="<?php echo $site_url_path; ?>images/zendesk-leadfwd.png" width="909" alt="">
            
            <ul class="ht3-box w230 pos1">
                <li>
                    <img class="ht3-box-img1" src="<?php echo $site_url_path; ?>images/john-q.png" alt="">
                </li>
                <li class="ht3-box-title blue">John Q. Hemi <img class="ht3-box-img2" src="<?php echo $site_url_path; ?>images/salesforce-small.png" alt=""></li>
                <li class="ht3-box-subtitle">Lead</li>
                <li class="ht3-box-details">New support ticket opened</li>
            </ul>
            ...
            <ul class="ht3-box w230 pos2">
                ...
                <li class="ht3-box-title blue">John Q. Hemi <img class="ht3-box-img2" src="<?php echo $site_url_path; ?>images/salesforce-small.png" alt=""></li>
                <li class="ht3-box-subtitle">Lead</li>
                <li class="ht3-box-details">+5 points for support ticket</li>
            </ul>
    ...
    <main class="wrapper-700 v2">
        ...
        <p class="f-16 mb20">
            ...
            Create automated rules to enroll contacts in Campaigns or Sequences based on support activity.
        </p>
        
        <p class="f-16 mb20">
            <span class="f-18 block">Score leads based on support</span>
            Create scoring profiles based on support activities and outcomes.
        </p>
        
        <p class="f-16 mb20">
            <span class="f-18 block">Support history for sales reps</span>
            Give sales reps access to their lead and customer support history, including ticket transcripts.
        </p>
        
        <p class="f-16 mb20">
            <span class="f-18 block">Visible inside CRM</span>
            Works with Leadfwd CRM Connectors to deliver support data and analytics to sales and marketing teams inside Salesforce, Sugar Sell and SuiteCRM.
        </p>
        
        <div class="icons-flex v2">
            <a href="javascript:void(0)">
                <span class="tooltip">Engage</span>
                <img src="<?php echo $site_url_path; ?>images/app-zendesk.png" width="28" alt="">
        ...
        <div class="ptb20">
            <a class="button-style-1 green mr10" href="#">Integration article</a>
