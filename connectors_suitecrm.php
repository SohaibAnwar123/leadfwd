...
<body>
        ...
        <div class="header-main noImg hm-dark">
            ...
            <div class="icons-flex">
                <a class="cursor" href="javascript:void(0)">
                    <img src="<?php echo $site_url_path; ?>images/app-suite-crm.png" width="40" alt="">
                </a>
    ...
    <div class="wrapper-940 center-al">
        
        <h5 class="centerAl">SuiteCRM + Leadfwd</h5>
        
        <img class="mb20" src="<?php echo $site_url_path; ?>images/suitecrm-leadfwd.png" width="738" alt="">
    ...
    <main class="wrapper-700 v2">
        ...
        <p class="f-16 mb20">
            <span class="f-18 block">Import Targets, Leads, Accounts, Contacts and Target Lists</span>
            Import all of your leads  and contacts directly into Leadfwd and begin adding them to Engage Sequences and Campaigns that automate communication, follow up, and track engagement.
        </p>
        
        <p class="f-16 mb20">
            <span class="f-18 block">Sync and map CRM users</span>
            Manage user roles across both platforms. User account ownership in SuiteCRM is automatically carried over to LeadFWD
        </p>
        
        <p class="f-16 mb20">
            <span class="f-18 block">One-click to engage</span>
            CRM users can seamlessly enroll any record into an Engage Sales Sequence with one-click, directly from their CRM interface
        </p>
        
        <p class="f-16 mb20">
            <span class="f-18 block">Revenue attribution</span>
            Measure the influence of Sequences, Campaigns and Content on open sales opportunities and won opportunities. Easily build re-engagement campaigns that target lost opportunities.
        </p>
        
        <p class="f-16 mb20">
            <span class="f-18 block">Tasks, Calls and Meetings</span>
            Automate task, call and meeting creation and scheduling for sales teams at the optimal time in your buyers journey.
        </p>
        
        <p class="f-16 mb20">
            <span class="f-18 block">Built-in to SuiteCRM</span>
            Leadfwd is deployed entirely inside SuiteCRM for seamless access to our full platform of solutions.
        </p>
        
        <p class="f-16 mb20">
            <span class="f-18 block">Supported objects</span>
            Leadfwd real-time sync for SuiteCRM can automatically import and maintain Leads, Contacts, Accounts, Targets, Target Lists, Users, Tasks, Calls, Meetings and Opportunities.
        </p>
        ...
        <div class="icons-flex v2">
            <a href="javascript:void(0)">
                ...
                <img src="<?php echo $site_url_path; ?>images/app-suite-crm.png" width="25" alt="">
            ...
            <a href="javascript:void(0)">
                <span class="tooltip">Prospect</span>
                <img src="<?php echo $site_url_path; ?>images/connector-prospect.png" width="31" alt="">
                <img src="<?php echo $site_url_path; ?>images/connectors-arrows-s.png" width="9" alt="">
                <img src="<?php echo $site_url_path; ?>images/app-suite-crm.png" width="25" alt="">
            </a>
            <a href="javascript:void(0)">
            ...
            <a href="javascript:void(0)">
                ...
                <img src="<?php echo $site_url_path; ?>images/connector-discover.png" width="31" alt="">
                <img src="<?php echo $site_url_path; ?>images/connectors-arrows-s.png" width="9" alt="">
                <img src="<?php echo $site_url_path; ?>images/app-suite-crm.png" width="25" alt="">
            </a>
        </div>
        ...
        <div class="ptb20">
            <a class="button-style-1 orange2 mr10" href="#">Integration article</a>
            <a class="button-style-1 dark" href="#">Learn more</a>
        </div>
