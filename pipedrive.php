...
<body class="light-cream">
    <?php include 'includes/analytics_body.php';?>

    <div class="pipeDrivePage">
        <!--Navigation-->
        ...
        <div class="header-type5 w1080 sugar_hero">
            <span class="ht5-title-1 blue1">SIDEBAR PLUGIN</span>
            <span class="ht5-title-2">Leadfwd Sequences Inside Pipedrive</span>
            <p>
                Execute all of your outbound sales engagement and drive more responses, in less time, with <b> Leadfwd
                    and Pipedrive. </b>
                Sync Pipedrive People to Sequences, View Contact Activity Insights and Execute Sales Tasks. All inside
                Pipedrive.
            </p>
            <div class="btnzWrap">
                <a href="https://chrome.google.com/webstore/detail/leadfwdai-sidebar/cgfpdaekohadjagbpmolmjdbgdchodjd" target="_blank" class="flex_align btn addChrome">Add to Chrome - It’s Free</a>
                <a href="https://help.leadfwd.com/hc/en-us/sections/9608860797331-Pipedrive" target="_blank" class="flex_align btn readDoc">Read Help Docs</a>
            </div>
        </div>
        <!--END Create Prospect Lists-->


        <!-- Stop Jumping sec start  -->
        <article class="white-1 surgarEngage_box">
            <section class="v2-grid7">

                <div class="v2-g7-content">
                    <div class="ht5-title-2">
                        Add Contacts <br>
                        To Sequences.
                    </div>
                    <p class="ptb20">Leadfwd extends automated sales outreach seamlessly
                        for Pipedrive using Sidebar. Enable your sales team to
                        effortlessly enroll contacts into sequences without
                        leaving their CRM</p>
                    <ul class="list5">
                        <li>Enroll Individual Contacts or Multiple Contacts</li>
                        <li>Personalize Email Outreach with Icebreakers</li>
                        <li>Auto-BCC Sales Emails to Pipedrive</li>
                    </ul>
                </div>

                <div class="l8-grid-img">
                    <img src="/images/pipeRow1.png" alt="">
                    <a class="l8-lightbox-open" href="javascript:void(0);"><img class="l8-grid-icon"
                            src="/images/fit-light-ic-green.png" width="100" alt="elnarge image"></a>
                </div>

                <div class="lightbox">
                    <img class="lightbox-size1" src="/images/pipeRow1.png" alt="">
                    <span class="close" alt="close">&#x2715;</span>
                </div>

            </section>
        </article>
        <!-- Stop Jumping sec end -->
        <!-- Pipeline sec start  -->
        <article class="white-1 surgarEngage_box bg_pipedrive">
            <section class="v2-grid7 flex_row_reverse">

                <div class="v2-g7-content">
                    <div class="ht5-title-2">360° Engagement <br>
                        Timeline & Insights
                    </div>
                    <p class="ptb20">Access the full engagement history and interaction profile
                        for Contacts inside Pipedrive that are synchronized with
                        Leadfwd.</p>
                    <ul class="list5">
                        <li>Engagement and Outreach Status </li>
                        <li>Engagement Timeline (35+ Activity Types)</li>
                        <li>Create, View and Complete Tasks</li>
                        <li>Quick Enroll to a Sequence with Icebreakers</li>
                    </ul>
                </div>

                <div class="l8-grid-img">
                    <img src="/images/pipeRow2.png" alt="">
                    <a class="l8-lightbox-open" href="javascript:void(0);"><img class="l8-grid-icon"
                            src="/images/fit-light-ic-green.png" width="100" alt="elnarge image"></a>
                </div>

                <div class="lightbox">
                    <img class="lightbox-size1" src="/images/pipeRow2.png" alt="">
                    <span class="close" alt="close">&#x2715;</span>
                </div>
        ...
        <!-- Pipeline sec end -->
        <!-- Multi-Channel sec start  -->
        <article class="white-1 surgarEngage_box">
            <section class="v2-grid7">

                <div class="v2-g7-content">
                    <div class="ht5-title-2">Multi-Channel
                        Sequences For
                        Pipedrive</div>
                    <p class="ptb20">With Sequences you can automate all your follow-up
                        activities; including Email, SMS, or LinkedIn. Enabling you
                        to focus on sales-ready deals, while Leadfwd focuses on
                        building pipeline with your next sales opportunities.</p>
                    <ul class="list5 channel_ul">
                        <li>Email</li>
                        <li>SMS</li>
                        <li>Manual Sales Tasks</li>
                        <li>Direct Mail</li>
                        <li>Voicemail Drops (RVM)</li>
                        <li>LinkedIn Engagement</li>
                    </ul>
                </div>

                <div class="l8-grid-img">
                    <img src="/images/pipeRow3.png" alt="">
                    <a class="l8-lightbox-open" href="javascript:void(0);"><img class="l8-grid-icon"
                            src="/images/fit-light-ic-green.png" width="100" alt="elnarge image"></a>
                </div>

                <div class="lightbox">
                    <img class="lightbox-size1" src="/images/pipeRow3.png" alt="">
                    <span class="close" alt="close">&#x2715;</span>
                </div>

            </section>
        </article>
        <!-- Multi-Channel sec end -->
        <!-- Primary Inbox sec start  -->
        <article class="white-1 surgarEngage_box bg_pipedrive">
            <section class="v2-grid7 flex_row_reverse">

                <div class="v2-g7-content">
                    <div class="ht5-title-2">Next/Gen
                        Cold Email
                        Software
                    </div>
                    <p class="ptb20">Satisfy the guardians of the primary inbox with a sales
                        engagement platform that is purpose-built using best
                        practices across IT, Sales and Marketing, to deliver your
                        message where it will be seen.</p>
                    <ul class="list5 channel_ul">
                        <li>Unlimited Mailboxes</li>
                        <li>Email Validation</li>
                        <li>Automatic Ramp-Up</li>
                        <li>Sender Rotation</li>
                        <li>AI Optimized Delivery</li>
                        <li>Spintax & Icebreakers</li>
                    </ul>
                </div>

                <div class="l8-grid-img">
                    <img src="/images/pipeRow4.png" alt="">
                    <a class="l8-lightbox-open" href="javascript:void(0);"><img class="l8-grid-icon"
                            src="/images/fit-light-ic-green.png" width="100" alt="elnarge image"></a>
                </div>

                <div class="lightbox">
                    <img class="lightbox-size1" src="/images/pipeRow4.png" alt="">
                    <span class="close" alt="close">&#x2715;</span>
                </div>

            </section>
        </article>
        <!-- Primary Inbox sec end -->
        <!-- Target Lists sec start  -->
        <article class="white-1 surgarEngage_box">
            <section class="v2-grid7">

                <div class="v2-g7-content">
                    <div class="ht5-title-2">Execute Tasks
                        at Scale</div>
                    <p class="ptb20">Just press ‘play’ and go. Leadfwd makes it easier than ever
                        to create, view and execute sales tasks in rapid succession. </p>
                    <ul class="list5">
                        <li>Auto-Loads Pipedrive Profile for Each Contact/Task</li>
                        <li>Fully Customizable Task Types, Objections and Outcomes.</li>
                        <li>Sync Tasks and Notes to Pipedrive using Zapier</li>
                    </ul>
                </div>

                <div class="l8-grid-img">
                    <img src="/images/pipeRow5.png" alt="">
                    <a class="l8-lightbox-open" href="javascript:void(0);"><img class="l8-grid-icon"
                            src="/images/fit-light-ic-green.png" width="100" alt="elnarge image"></a>
                </div>

                <div class="lightbox">
                    <img class="lightbox-size1" src="/images/pipeRow5.png" alt="">
                    <span class="close" alt="close">&#x2715;</span>
                </div>

            </section>
        </article>
        <!-- Target Lists sec end -->
    ...
    <script>
        // enlarge image
        $("a.l8-grid-img-link").click(function () {
            $(this).find('.l8-grid-img').addClass('opened');
        });

        $(document).mouseup(function (e) {
            var container = $(".l8-grid-img.opened");
            // If the target of the click isn't the container
            if (!container.is(e.target) && container.has(e.target).length === 0) {
                $('.l8-grid-img.opened').removeClass('opened');
